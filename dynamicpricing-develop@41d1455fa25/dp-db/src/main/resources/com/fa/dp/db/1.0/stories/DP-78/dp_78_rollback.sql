...
ALTER TABLE `DP_WEEKN_PARAMS`
	DROP COLUMN `PRIVATE_MORTGAGE_INSURANCE`,
	DROP COLUMN `SELLER_OCCUPIED_PROPERTY`,
	DROP COLUMN `LIST_PRCE_NT`,
	DROP COLUMN `LIST_STRT_DATE_DT_NN`,
	DROP COLUMN `LIST_END_DATE_DT_NN`,
	DROP COLUMN `LIST_STTS_DTLS_VC`,
	CHANGE COLUMN `RBID_PROP_ID_VC_PK` `SELR_PROP_ID_VC_NN` VARCHAR(50) NULL DEFAULT NULL AFTER `EXCLUSION_REASON`;
...
(UUID(), 'weekNAssignmentFilter', 'PREPARE_WEEKN_DATA', 2, 'WEEKN', TRUE, 'SYSTEM', UNIX_TIMESTAMP(NOW()));
