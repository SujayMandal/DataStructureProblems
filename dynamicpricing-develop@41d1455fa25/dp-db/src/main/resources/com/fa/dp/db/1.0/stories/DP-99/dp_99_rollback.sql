...
UPDATE `RA_TNT_APP_PARAMS` SET `ATTR_VALUE` = 'wk0_50' WHERE `ATTR_KEY` = 'nrz.pricemode.input';
UPDATE `RA_TNT_APP_PARAMS` SET `ATTR_VALUE` = 'wk0_standard' WHERE `ATTR_KEY` = 'ocn.pricemode.input';
