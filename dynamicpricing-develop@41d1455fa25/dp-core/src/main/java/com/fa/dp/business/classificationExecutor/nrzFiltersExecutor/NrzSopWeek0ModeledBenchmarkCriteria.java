...
@Named
@CommandDescription(name = "nrzSopWeek0ModeledBenchmarkCriteria")
public class NrzSopWeek0ModeledBenchmarkCriteria extends AbstractSopWeek0ModeledBenchmarkCriteria {
	...
	public void execute(Object data) throws SystemException {
		executeSopWeek0ModeledBenchmarkCriteria(data, DPAConstants.NRZ_SOP_WEEK0_MODELED_BENCHMARK_CRITERIA);
	}
}
