...
@Named
@Scope("prototype")
@CommandDescription(name = "weekNEmailIntegration")
public class WeekNEmailIntegration extends AbstractCommand {

	private static final Logger LOGGER = LoggerFactory.getLogger(WeekNEmailIntegration.class);
	...
	public void execute(Object data) throws SystemException {
		LOGGER.info("weekNEmailIntegration -> processTask started.");
		...
		LOGGER.info("weekNEmailIntegration -> processTask ended.");
