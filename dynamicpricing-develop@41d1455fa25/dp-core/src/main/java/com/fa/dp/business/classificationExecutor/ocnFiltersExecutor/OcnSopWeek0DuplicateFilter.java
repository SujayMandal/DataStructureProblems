...
@Named
@CommandDescription(name = "ocnSopWeek0DuplicateFilter")
public class OcnSopWeek0DuplicateFilter extends AbstractSopWeek0DuplicateFilter {
	/**
	...
	public void execute(Object data) throws SystemException {
		executeSopWeek0DuplicateFilter(data, DPAConstants.OCN_SOP_DUPLICATE_FILTER);
	}
}
