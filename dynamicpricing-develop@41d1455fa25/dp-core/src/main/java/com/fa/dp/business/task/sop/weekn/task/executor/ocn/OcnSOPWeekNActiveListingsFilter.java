...
@Named
@CommandDescription(name = DPAConstants.OCN_SOPWEEKN_ACTIVE_LISTINGS_FILTER)
public class OcnSOPWeekNActiveListingsFilter extends AbstractSOPWeekNActiveListingsFilter {
