...
public final class UsageReportUtil1 {
	...
	public static String getModelVersion(final TransactionDocumentInfo documentInfo) {
		final int majorVersion = documentInfo.getMajorVersion();
		final int minorVersion = documentInfo.getMinorVersion();
	...
	public static String getFormattedRunAsOfDate(TransactionDocumentInfo documentInfo) {
		final long runAsOfDateMilliseconds = documentInfo.getCreatedDate();
	...
	public static String getProcessingStatus(final TransactionDocumentInfo documentInfo) {
		final String cellValue = documentInfo.getStatus();
