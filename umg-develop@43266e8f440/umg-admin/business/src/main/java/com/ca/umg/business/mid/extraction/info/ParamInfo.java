...
import com.ca.umg.business.util.XmlAttribute;
...
public class ParamInfo implements Serializable {
    ...
    @XmlAttribute(name = "mandatory", type = DataType.BOOLEAN)
    ...
    @XmlAttribute(name = "syndicate", type = DataType.BOOLEAN)
    ...
    @XmlAttribute(name = "sequence", type = DataType.INT)
	...
	@XmlAttribute(name = "nativeDataType", type = DataType.STRING)
	...
	@XmlAttribute(name = "modelParamName")
	...
	@XmlAttribute(name = "acceptableValues", type = DataType.STRING)
