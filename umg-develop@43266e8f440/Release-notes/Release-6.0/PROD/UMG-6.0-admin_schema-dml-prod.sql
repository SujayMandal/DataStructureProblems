...
update POOL set PRIORITY = 104 where ID = 5;
...
update POOL set PRIORITY = 201 where ID = 2;
...
update POOL set PRIORITY = 1 where ID = 2;
update POOL set PRIORITY = 2 where ID = 1;
