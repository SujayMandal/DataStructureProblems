...
CREATE TABLE MODEL_EXECUTION_ENVIRONMENTS(
	...
	CREATED_ON BIGINT NOT NULL,
	LAST_UPDATED_BY CHARACTER(50),
	LAST_UPDATED_ON BIGINT,
	PRIMARY KEY (ID)
);

CREATE TABLE MODEL_EXECUTION_ENVIRONMENTS_AUD(
	ID CHARACTER(36) NOT NULL,
	...
	REVTYPE TINYINT DEFAULT 0 NOT NULL,
	PRIMARY KEY (ID,REV)
);
...
CREATE TABLE MODEL_LIBRARY (
	...
	MODEL_EXEC_ENV_NAME VARCHAR(50) NOT NULL,
	R_MANIFEST_FILE_NAME VARCHAR(100) NULL,
	CREATED_BY CHAR(36) NOT NULL, 
	CREATED_ON BIGINT NOT NULL,
	LAST_UPDATED_BY CHAR(36), 
	LAST_UPDATED_ON BIGINT NULL,
...
CREATE TABLE MODEL_EXEC_PACKAGES(
	ID CHARACTER(36) NOT NULL,
	TENANT_ID VARCHAR(45) NOT NULL,
	MODEL_EXEC_ENV_ID CHARACTER(36) NOT NULL,
	PACKAGE_NAME VARCHAR(200) NOT NULL,
	PACKAGE_VERSION VARCHAR(50) NOT NULL,
	PACKAGE_TYPE VARCHAR(50) NOT NULL,
	COMPILED_OS VARCHAR(50) NOT NULL,
	CREATED_BY CHARACTER(50) NOT NULL,
	CREATED_ON BIGINT NOT NULL,
	LAST_UPDATED_BY CHARACTER(50),
	LAST_UPDATED_ON BIGINT NULL,
...
CREATE TABLE MODEL_EXEC_PACKAGES_AUD(
	ID CHARACTER(36) NOT NULL,
	TENANT_ID VARCHAR(45) NOT NULL,
	MODEL_EXEC_ENV_ID CHARACTER(36),
	PACKAGE_NAME VARCHAR(200),
	PACKAGE_VERSION VARCHAR(50),
	PACKAGE_TYPE VARCHAR(50),
	COMPILED_OS VARCHAR(50),
	REV INTEGER NOT NULL,
	REVTYPE TINYINT DEFAULT 0 NOT NULL,
	CREATED_BY CHARACTER(50),
	CREATED_ON BIGINT NULL,
...
CREATE TABLE MODEL_LIB_EXEC_PKG_MAPPING(
	ID CHARACTER(36) NOT NULL,
	TENANT_ID VARCHAR(45) NOT NULL,
	MODEL_LIBRARY_ID CHARACTER(36) NOT NULL,
	MODEL_EXEC_PKG_ID CHARACTER(36) NOT NULL,
	EXEC_SEQUENCE INTEGER NOT NULL,
...
CREATE TABLE MODEL_LIB_EXEC_PKG_MAPPING_AUD(
	ID CHARACTER(36) NOT NULL,
	TENANT_ID VARCHAR(45),
	MODEL_LIBRARY_ID CHARACTER(36),
	MODEL_EXEC_PKG_ID CHARACTER(36),
...
CREATE TABLE SYNDICATE_DATA_QUERY (
  ...
  WHERE_COMPONENT VARCHAR(500),
  ORDER_BY_COMPONENT VARCHAR(100),
...
CREATE TABLE  SYNDICATE_DATA_QUERY_INPUTS (
  ...
  DATATYPE_FORMAT VARCHAR(50),
  SAMPLE_VALUE VARCHAR(50),
  CREATED_BY CHAR(36) NOT NULL, 
  CREATED_ON BIGINT NOT NULL,
  LAST_UPDATED_BY CHAR(36), 
  LAST_UPDATED_ON BIGINT NULL,
...
ALTER TABLE UMG_VERSION ADD COLUMN MODEL_TYPE VARCHAR(10) NOT NULL;

ALTER TABLE UMG_VERSION_AUD ADD COLUMN MODEL_TYPE VARCHAR(10) NOT NULL;
