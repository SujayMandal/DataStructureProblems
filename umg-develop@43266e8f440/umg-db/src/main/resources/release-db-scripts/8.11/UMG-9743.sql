...
INSERT INTO `SYSTEM_PARAMETER` (`ID`, `SYS_KEY`, `SYS_VALUE`, `IS_ACTIVE`, `CREATED_BY`, `CREATED_ON`,`LAST_UPDATED_BY`, `LAST_UPDATED_ON`) VALUES (UUID(), 'ALLOWED_HOSTS', 'ecma.com', 'Y', 'system', @CREATED_ON , 'system', @CREATED_ON);
commit;
