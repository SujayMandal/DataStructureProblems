...
VALUES
('d60de758-e6fb-11e3-aab5-82687f4fc15c',@tenant_ocwen,@system_key_db_driver,'com.mysql.jdbc.ReplicationDriver','SYSTEM',1401344421,'SYSTEM',1401344421),
('d60dea46-e6fb-11e3-aab5-82687f4fc15c',@tenant_ocwen,@system_key_db_url,'jdbc:mysql:replication://localhost:3306,localhost:3307/ocwen?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=true&loadBalanceBlacklistTimeout=5000autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
...
INSERT INTO TENANT_CONFIG(ID,TENANT_ID,SYSTEM_KEY_ID,CONFIG_VALUE,CREATED_BY,CREATED_ON,LAST_UPDATED_BY,LAST_UPDATED_ON)
VALUES
('d60df22a-e6fb-11e3-aab5-82687f4fc15c',@tenant_equator,@system_key_db_driver,'com.mysql.jdbc.ReplicationDriver','SYSTEM',1401344421,'SYSTEM',1401344421),
('d60df40a-e6fb-11e3-aab5-82687f4fc15c',@tenant_equator,@system_key_db_url,'jdbc:mysql:replication://localhost:3306,localhost:3307/equator?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=true&loadBalanceBlacklistTimeout=5000autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
...
INSERT INTO TENANT_CONFIG(ID,TENANT_ID,SYSTEM_KEY_ID,CONFIG_VALUE,CREATED_BY,CREATED_ON,LAST_UPDATED_BY,LAST_UPDATED_ON)
VALUES
('1ff13bfe-e6fc-11e3-aab5-82687f4fc15c',@tenant_altisource,@system_key_db_driver,'com.mysql.jdbc.ReplicationDriver','SYSTEM',1401344421,'SYSTEM',1401344421),
('1ff13ed8-e6fc-11e3-aab5-82687f4fc15c',@tenant_altisource,@system_key_db_url,'jdbc:mysql:replication://localhost:3306,localhost:3307/altisource?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=true&loadBalanceBlacklistTimeout=5000&autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
...
INSERT INTO TENANT_CONFIG(ID,TENANT_ID,SYSTEM_KEY_ID,CONFIG_VALUE,CREATED_BY,CREATED_ON,LAST_UPDATED_BY,LAST_UPDATED_ON)
VALUES
('d4f48c66-e730-11e3-b953-82687f4fc15c',@tenant_localhost,@system_key_db_driver,'com.mysql.jdbc.ReplicationDriver','SYSTEM',1401344421,'SYSTEM',1401344421),
('d4f48f5e-e730-11e3-b953-82687f4fc15c',@tenant_localhost,@system_key_db_url,'jdbc:mysql:replication://localhost:3306,localhost:3307/localhost?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=true&loadBalanceBlacklistTimeout=5000&autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
...
INSERT INTO TENANT_CONFIG(ID,TENANT_ID,SYSTEM_KEY_ID,CONFIG_VALUE,CREATED_BY,CREATED_ON,LAST_UPDATED_BY,LAST_UPDATED_ON)
VALUES
('421610ba-e7d3-11e3-b99a-82687f4fc15c',@tenant_blrltf3xrvs1,@system_key_db_driver,'com.mysql.jdbc.ReplicationDriver','SYSTEM',1401344421,'SYSTEM',1401344421),
('421614c0-e7d3-11e3-b99a-82687f4fc15c',@tenant_blrltf3xrvs1,@system_key_db_url,'jdbc:mysql:replication://localhost:3306,localhost:3307/blr-lt-f3xrvs1?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=true&loadBalanceBlacklistTimeout=5000&autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
