INSERT INTO umg_admin.SYSTEM_PARAMETER
	(id,sys_key,sys_value,is_active,created_by,created_on,last_updated_by,last_updated_on)
		VALUES('789B7B7F-192A-4BD4-B156-BEDF9C1A00EA','timeout','3600','Y','system',1417439330020,'system',1417439330020);
...
INSERT INTO umg_admin.SYSTEM_PARAMETER
	(id,sys_key,sys_value,is_active,created_by,created_on,last_updated_by,last_updated_on)
		VALUES('911DD83E-C514-466A-8768-DED5DAADCC25','me2URL','http://rauat-webserver3.altidev.net/umg-me2/modelExecEngine/execute','Y','system',1417439330020,'system',1417439330020);
commit;
