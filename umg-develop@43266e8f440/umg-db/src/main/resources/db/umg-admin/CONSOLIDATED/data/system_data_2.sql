...
('d60dea46-e6fb-11e3-aab5-82687f4fc15c',@tenant_ocwen,@system_key_db_url,'jdbc:mysql:loadbalance://localhost:3306,localhost:3307/ocwen?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=false&loadBalanceBlacklistTimeout=5000&autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
...
('421614c0-e7d3-11e3-b99a-82687f4fc15c',@tenant_blrltf3xrvs1,@system_key_db_url,'jdbc:mysql:loadbalance://localhost:3306,localhost:3307/blr-lt-f3xrvs1?loadBalanceConnectionGroup=first&loadBalanceEnableJMX=false&loadBalanceBlacklistTimeout=5000&autoReconnect=true&autoReconnectForPools=true','SYSTEM',1401344421,'SYSTEM',1401344421),
