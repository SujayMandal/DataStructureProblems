...
VALUES
('907c88be-3c57-11e6-b0ae-00ffde411c75','owners','owners','owners','both','ROd9MtPWyBQg1/faWof1GCe35V41XLWIriAN/mEkV3vn0n88+knylNCeN8ka521U','SYSTEM',1439969318,'SYSTEM',1439969318);


SELECT @tenant_name:=(SELECT ID FROM TENANT WHERE CODE='owners');
