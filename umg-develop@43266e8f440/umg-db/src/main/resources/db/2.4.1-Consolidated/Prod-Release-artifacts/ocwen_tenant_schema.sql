...
SELECT @tenantcode_equator:=(SELECT CODE FROM umg_admin.TENANT WHERE CODE='equator');

INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`) VALUES ('C7642E72-DE1B-4E5B-B1B1-0C70E1B3BCA5', @tenantcode_equator, 'Matlab', '7.16', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416);
INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`) VALUES ('F6ACD2A3-D78D-4E36-A2D8-7420F7CF7534', @tenantcode_equator, 'R', '3.1.2', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416);
...
INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS_AUDIT` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`, `REV`, `REVTYPE`) VALUES ('C7642E72-DE1B-4E5B-B1B1-0C70E1B3BCA5', @tenantcode_equator, 'Matlab', '7.16', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416, @MAXREV, 0);

SELECT @MAXREV:=(select max(REV) from REVINFO)+1;
INSERT INTO `REVINFO` (`REV`, `REVTSTMP`, `REVBY`) VALUES (@MAXREV, 1418730666011, 'nagamani.basa');

INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS_AUDIT` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`, `REV`, `REVTYPE`) VALUES ('F6ACD2A3-D78D-4E36-A2D8-7420F7CF7534', @tenantcode_equator, 'R', '3.1.2', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416, @MAXREV, 0);
...
UPDATE `MODEL_LIBRARY` SET MODEL_EXEC_ENV_ID = (SELECT ID FROM MODEL_EXECUTION_ENVIRONMENTS WHERE lower(EXECUTION_ENVIRONMENT) = 'matlab' 
AND ENVIRONMENT_VERSION = '7.16' AND TENANT_ID = 'ocwen') WHERE lower(EXECUTION_LANGUAGE) = 'matlab' AND TENANT_ID = 'ocwen';

UPDATE `MODEL_LIBRARY` SET MODEL_EXEC_ENV_ID = (SELECT ID FROM MODEL_EXECUTION_ENVIRONMENTS WHERE lower(EXECUTION_ENVIRONMENT) = 'matlab'
AND ENVIRONMENT_VERSION = '7.16' AND TENANT_ID = 'equator') WHERE lower(EXECUTION_LANGUAGE) = 'matlab' AND TENANT_ID = 'equator';

UPDATE `MODEL_LIBRARY` SET MODEL_EXEC_ENV_ID = (SELECT ID FROM MODEL_EXECUTION_ENVIRONMENTS WHERE lower(EXECUTION_ENVIRONMENT) = 'r' 
AND ENVIRONMENT_VERSION = '3.1.2' AND TENANT_ID='ocwen') WHERE lower(EXECUTION_LANGUAGE) = 'r' AND TENANT_ID = 'ocwen';

UPDATE `MODEL_LIBRARY` SET MODEL_EXEC_ENV_ID = (SELECT ID FROM MODEL_EXECUTION_ENVIRONMENTS WHERE lower(EXECUTION_ENVIRONMENT) = 'r' 
AND ENVIRONMENT_VERSION = '3.1.2' AND TENANT_ID='equator') WHERE lower(EXECUTION_LANGUAGE) = 'r' AND TENANT_ID = 'equator';
