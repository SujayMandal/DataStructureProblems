...
-- Dumping database structure for prod-seed
CREATE DATABASE IF NOT EXISTS `prod-seed` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `prod-seed`;


-- Dumping structure for table prod-seed.address
...
-- Dumping structure for table prod-seed.authtoken
...
-- Dumping structure for table prod-seed.command
...
-- Dumping structure for table prod-seed.model_execution_environments
...
-- Dumping structure for table prod-seed.model_exec_packages
...
-- Dumping structure for table prod-seed.model_exec_packages_audit
...
-- Dumping structure for table prod-seed.model_implementation_type
...
-- Dumping structure for table prod-seed.notification_email_template
...
-- Dumping structure for table prod-seed.notification_event
...
-- Dumping structure for table prod-seed.notification_event_template_mapping
...
-- Dumping structure for table prod-seed.notification_sms_template
...
-- Dumping structure for table prod-seed.notification_type
...
-- Dumping structure for table prod-seed.permissions
...
-- Dumping structure for table prod-seed.permission_roles_mapping
...
-- Dumping structure for table prod-seed.pool
...
-- Dumping structure for table prod-seed.pool_criteria
...
-- Dumping structure for table prod-seed.pool_criteria_def_mapping
...
-- Dumping structure for table prod-seed.pool_usage_order
...
-- Dumping structure for table prod-seed.revinfo
...
-- Dumping structure for table prod-seed.roles
...
-- Dumping structure for table prod-seed.syndicated_data
...
-- Dumping structure for table prod-seed.syndicated_data_audit
...
-- Dumping structure for table prod-seed.system_key
...
-- Dumping structure for table prod-seed.system_modelets
...
-- Dumping structure for table prod-seed.system_parameter
...
-- Dumping structure for table prod-seed.system_parameter_audit
...
-- Dumping structure for table prod-seed.tenant
...
-- Dumping structure for table prod-seed.tenant_config
...
-- Dumping structure for table prod-seed.tenant_roles_mapping
...
-- Dumping structure for table prod-seed.tenant_user_mapping
...
-- Dumping structure for table prod-seed.tenant_user_tenant_role_mapping
...
-- Dumping structure for table prod-seed.transport_parameters
...
-- Dumping structure for table prod-seed.transport_types
...
-- Dumping structure for table prod-seed.users
...
-- Dumping structure for table prod-seed.users_login_audit
