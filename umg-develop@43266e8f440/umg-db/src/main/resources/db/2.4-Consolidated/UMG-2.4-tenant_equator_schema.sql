...
INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`) VALUES ('C7642E72-DE1B-4E5B-B1B1-0C70E1B3BCA6', @tenantcode_equator, 'Matlab', '7.16', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416);
INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`) VALUES ('F6ACD2A3-D78D-4E36-A2D8-7420F7CF7537', @tenantcode_equator, 'R', '3.1.2', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416);
...
INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS_AUDIT` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`, `REV`, `REVTYPE`) VALUES ('C7642E72-DE1B-4E5B-B1B1-0C70E1B3BCA6', @tenantcode_equator, 'Matlab', '7.16', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416, @MAXREV, 0);

SELECT @MAXREV:=(select max(REV) from REVINFO)+1;
INSERT INTO `REVINFO` (`REV`, `REVTSTMP`, `REVBY`) VALUES (@MAXREV, 1418730666011, 'nagamani.basa');

INSERT INTO `MODEL_EXECUTION_ENVIRONMENTS_AUDIT` (`ID`, `TENANT_ID`, `EXECUTION_ENVIRONMENT`, `ENVIRONMENT_VERSION`, `CREATED_BY`, `CREATED_ON`, `LAST_UPDATED_BY`, `LAST_UPDATED_ON`, `REV`, `REVTYPE`) VALUES ('F6ACD2A3-D78D-4E36-A2D8-7420F7CF7537', @tenantcode_equator, 'R', '3.1.2', 'nagamani.basa', 1433246416, 'nagamani.basa', 1433246416, @MAXREV, 0);
